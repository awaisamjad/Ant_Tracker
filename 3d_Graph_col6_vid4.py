...
fig = plt.figure()
df = pd.read_csv("sorted_data\colony_6_data_vid_4.csv") # reading in data from colony 6 video 4 csv
...
ani = animation.FuncAnimation(fig, update, frames=np.arange(0, 360, 1), interval=50) # saves the animation
